...
class PoseGraphKeyFrame {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.int32(obj.keyframe_id, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PoseGraphKeyFrame(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [keyframe_id]
    data.keyframe_id = _deserializer.int32(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new PoseGraphKeyFrame(null);
...
module.exports = PoseGraphKeyFrame;
