...
if("TRUE" STREQUAL "TRUE")
  set(graph_d_exploration_SOURCE_PREFIX /home/usr/data/ExplOrbSLAM_working/src/src/graph_d_exploration)
  set(graph_d_exploration_DEVEL_PREFIX /home/usr/data/ExplOrbSLAM_working/devel/.private/graph_d_exploration)
  ...
  set(graph_d_exploration_INSTALL_PREFIX /home/usr/data/ExplOrbSLAM_working/install)
...
if(NOT "/home/usr/data/ExplOrbSLAM_working/devel/.private/graph_d_exploration/include " STREQUAL " ")
  set(graph_d_exploration_INCLUDE_DIRS "")
  set(_include_dirs "/home/usr/data/ExplOrbSLAM_working/devel/.private/graph_d_exploration/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'graph_d_exploration' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/usr/data/ExplOrbSLAM_working/src/src/graph_d_exploration/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/usr/data/ExplOrbSLAM_working/devel/.private/graph_d_exploration/lib;/home/usr/data/ExplOrbSLAM_working/devel/lib;/opt/ros/noetic/lib)
