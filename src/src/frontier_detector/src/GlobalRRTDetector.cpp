...
int main(int argc, char **argv){
  ...
  std::string map_topic, collab_map_topic,base_frame_topic;
  ...
  while (ros::ok()){
    ...
    if (x_new[0]>gridMap.info.origin.position.x && x_new[0]<(gridMap.info.origin.position.x+gridMap.info.width * gridMap.info.resolution) && \
        x_new[1]>gridMap.info.origin.position.y && x_new[1]<(gridMap.info.origin.position.y+gridMap.info.height * gridMap.info.resolution)){
