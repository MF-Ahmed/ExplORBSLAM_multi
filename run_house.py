...
ros1_mapserver = "rosrun map_server map_server /home/usr/data/ExplOrbSLAM_working/src/src/maps/house/house_new.yaml"
ros1_mapsaver = "rosrun map_server map_saver -f /home/usr/data/ExplOrbSLAM_working/OG_maps/house/$map_$(date +'%Y%m%d_%H%M%S') map:=/mergedmap"


run_lawn_mover = "python3 /home/usr/data/ExplOrbSLAM_working/src/src/robot_description/src/python/lawn_mower.py"
