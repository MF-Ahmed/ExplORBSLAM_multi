...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MergePointsGoal>)))
  ...
  "63e476301d9f3c67c68b09ab685fcd2b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MergePointsGoal)))
  "Returns md5sum for a message object of type 'MergePointsGoal"
  "63e476301d9f3c67c68b09ab685fcd2b")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MergePointsGoal>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Define a message type for passing an array of points to the server and getting the merged points back~%~%# Define the action goal message~%string client_id~%Point2D[] points~%~%================================================================================~%MSG: graph_d_exploration/Point2D~%# Point for centroids~%float32 x~%float32 y~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MergePointsGoal)))
  "Returns full string definition for message of type 'MergePointsGoal"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Define a message type for passing an array of points to the server and getting the merged points back~%~%# Define the action goal message~%string client_id~%Point2D[] points~%~%================================================================================~%MSG: graph_d_exploration/Point2D~%# Point for centroids~%float32 x~%float32 y~%~%"))
