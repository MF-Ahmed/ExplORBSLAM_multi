...
void GridMapper::Init () {
    ...
    map_publisher_ = node_handle_.advertise<nav_msgs::OccupancyGrid>(name_of_node_+"/map", 5, 10);
...
void GridMapper::initializeParams(ros::NodeHandle &nh){
    ...
    nh.param<double>(name_of_node_+"/occupancy/projected_map/min_height", projection_min_height_,  0.0);
