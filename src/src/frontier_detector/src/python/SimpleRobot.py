...
class Robot:
    def __init__(self, name: str):
        ...
        self.global_frame = rospy.get_param('~global_frame', self.namespace+'/map')
        self.robot_frame = rospy.get_param('~robot_frame', self.namespace+'/base_link')
        ...
        #self.plan_service = rospy.get_param('~plan_service', '/move_base/GlobalPlanner/make_plan')
        self._plan_service = '/' + self.name + self.plan_service
        rospy.wait_for_service(self._plan_service)
        rospy.loginfo(rospy.get_name() + ': got plan service.')
        self.make_plan = rospy.ServiceProxy(self._plan_service, GetPlan)
