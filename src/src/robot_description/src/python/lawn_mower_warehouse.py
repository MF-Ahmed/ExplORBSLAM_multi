...
class LawnMowerControl:
    ...
    def command_loop(self, ev):
        ...
        if self.timestep == 7:
            self.drone_land(7) # decrease the height                
