...
class MergePointsActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MergePointsGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += MergePointsGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MergePointsActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = MergePointsGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new MergePointsGoal()
    }
...
module.exports = MergePointsActionGoal;
