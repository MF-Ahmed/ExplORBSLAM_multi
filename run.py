...
ros1_mapsaver = "rosrun map_server map_saver -f /home/farhan/data/ros1_ws/src/thesis_ws/results/simulation/WillowGarage/maps/$map_$(date +'%Y%m%d_%H%M%S')"
ros1_killplotnode = "rosnode kill /plotter_node"
ros1_mapserver = "rosrun map_server map_server /home/farhan/data/ExplOrbSLAM_ws/src/src/maps/house/aws_house.yaml"
run_lawn_mover = "python3 /home/farhan/data/ExplOrbSLAM_ws/src/src/robot_description/src/python/lawn_mower.py"
