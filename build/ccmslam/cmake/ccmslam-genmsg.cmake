...
get_filename_component(_filename "/home/usr/data/ExplOrbSLAM_working/src/ccmslam_working_withMono/src/ccm_slam/cslam/srv/ServiceSaveMap.srv" NAME_WE)
add_custom_target(_ccmslam_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ccmslam" "/home/usr/data/ExplOrbSLAM_working/src/ccmslam_working_withMono/src/ccm_slam/cslam/srv/ServiceSaveMap.srv" ""
)
...
_generate_srv_cpp(ccmslam
  "/home/usr/data/ExplOrbSLAM_working/src/ccmslam_working_withMono/src/ccm_slam/cslam/srv/ServiceSaveMap.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ccmslam)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ccmslam\")")
  # install generated code
  install(
