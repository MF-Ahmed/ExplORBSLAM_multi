...
"""autogenerated by genpy from graph_d_exploration/ChooseGoalActionResult.msg. Do not edit."""
import codecs
import sys
...
class ChooseGoalActionResult(genpy.Message):
  _md5sum = "0c8bfa7446067e8cbfd5b34b516f8ebd"
  _type = "graph_d_exploration/ChooseGoalActionResult"
...
float32 y"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','graph_d_exploration/ChooseGoalResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ChooseGoalActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = graph_d_exploration.msg.ChooseGoalResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = graph_d_exploration.msg.ChooseGoalResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.result.goals)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.goals:
        _x = val1
